...
function TabBar({
  ...
  return (
    <div className="flex items-stretch border-b border-line bg-surface-muted overflow-x-auto scroll-thin">
      {tabs.map((t) => {
        ...
        return (
          <div
            key={t.id}
            className={[
              "group flex items-center gap-2 pl-3 pr-1 py-2 border-r border-line max-w-[200px] cursor-pointer",
      ...
      <div ref={menuRef} className="relative">
        ...
        {menuOpen && (
          <div className="absolute top-full left-0 mt-1 z-20 w-48 bg-surface-elev border border-line rounded-md shadow-lg py-1">
            <MenuItem
            ...
            >
              新規ターミナル
              <span className="ml-1 text-fg-faint text-[10px]">(tmux window)</span>
            </MenuItem>
            <MenuItem
